...
//    _XCTPrimitiveAssertNotEqual(test, expression1, @#expression1, expression2, @#expression2, __VA_ARGS__)
    ...
    func testCopy() throws {
        ...
        try checkListCopy(list2, original: list, forTest: description)
    }
    ...
    func testAtomCopy() throws {
        ...
        try checkAtomCopy(copy, original: atom, forTest: description)
        try checkListCopy(copy.superScript, original: atom.superScript, forTest: description)
        try checkListCopy(copy.subScript, original: atom.subScript, forTest: description)
    }
    ...
    func testCopyFraction() throws {
        ...
        try checkAtomCopy(copy, original: frac, forTest: description)
        try checkListCopy(copy.numerator, original: frac.numerator, forTest: description)
        try checkListCopy(copy.denominator, original: frac.denominator, forTest: description)
    ...
    func testCopyRadical() throws {
        ...
        try checkAtomCopy(copy, original: rad, forTest: description)
        try checkListCopy(copy.radicand, original: rad.radicand, forTest: description)
        try checkListCopy(copy.degree, original: rad.degree, forTest: description)
    }
    ...
    func testCopyLargeOperator() throws {
        ...
        try checkAtomCopy(copy, original: lg, forTest: description)
    ...
    func testCopyInner() throws {
        ...
        try checkAtomCopy(copy, original: inner, forTest: description)
        try checkListCopy(copy.innerList, original: inner.innerList, forTest: description)
        try checkAtomCopy(copy.leftBoundary!, original: inner.leftBoundary, forTest: description)
        try checkAtomCopy(copy.rightBoundary, original: inner.rightBoundary, forTest: description)
    }
    ...
    func testCopyOverline() throws {
        ...
        try checkAtomCopy(copy, original: over, forTest: description)
        try checkListCopy(copy.innerList, original: over.innerList, forTest: description)
    }
    ...
    func testCopyUnderline() throws {
        ...
        try checkAtomCopy(copy, original: under, forTest: description)
        try checkListCopy(copy.innerList, original: under.innerList, forTest: description)
    }
    ...
    func testCopyAcccent() throws {
        ...
        try checkAtomCopy(copy, original: accent, forTest: description)
        try checkListCopy(copy.innerList, original: accent.innerList, forTest: description)
    }
    ...
    func testCopySpace() throws {
        ...
        try checkAtomCopy(copy, original: space, forTest: description)
    ...
    func testCopyStyle() throws {
        ...
        try checkAtomCopy(copy, original: style, forTest: description)
    ...
    func testCopyMathTable() throws {
        ...
        try checkAtomCopy(copy, original: table, forTest: description)
        ...
        try checkListCopy(copy.cells[0][1], original: list, forTest: description)
        try checkListCopy(copy.cells[0][2], original: list2, forTest: description)
    }
}
