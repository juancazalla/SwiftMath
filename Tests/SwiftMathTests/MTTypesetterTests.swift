...
final class MTTypesetterTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        font = MTFontManager.shared.defaultFont
    }
...
//        XCTAssertEqual(r1.length, r2.length, __VA_ARGS__)
    ...
    func testSpacing() throws {
        ...
        let noSpaceDisplay = MTTypesetter.createLineForMathList(noSpace, font: font, style: .display)!
    ...
    func testVariables() throws {
        ...
        for symName in allSymbols {
            ...
            try testAtomWithAllFontStyles(atom)
        }
    ...
    func testStyleChanges() throws {
        ...
        let display = MTTypesetter.createLineForMathList(textList, font: font, style: .display)!
        let textDisplay = MTTypesetter.createLineForMathList(list, font: font, style: .text)!
        let originalDisplay = MTTypesetter.createLineForMathList(list, font: font, style: .display)!
