...
public enum MTMathAtomFactory {
    ...
    static var _accentValueToName: [String: String]?
    ...
    static var _textToLatexSymbolName: [String: String]?
    public static var textToLatexSymbolName: [String: String] {
        get {
            if _textToLatexSymbolName == nil {
                var output = [String: String]()
                ...
                _textToLatexSymbolName = output
            }
            return _textToLatexSymbolName!
        }
        set {
            _textToLatexSymbolName = newValue
        }
    }
